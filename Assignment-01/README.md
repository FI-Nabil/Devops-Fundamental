...
* `while [ $# -gt 0 ]` --> it loops over the commnad-line arguments until anything left. 
* `shift` --> shift remove the first argument and shift the index of the remaining to the left.
* `awk` --> a command line used for text processing.